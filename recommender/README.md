...
<p>После этого я вручную откорректировал оценки релевантности, исходя из того, какие склады выбирались по определенным запросам, какие склады действительно подходят по запросу.</p>
<p></p>
