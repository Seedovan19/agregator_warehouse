...
from connect import Warehouses
...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        wh = Warehouses()
        dataset = wh.get(wh.api_url)
        columns = ['name', 'logistics.parking']
        df = pd.DataFrame(pd.json_normalize(dataset["results"]), columns=columns)
...
# },
# "logistics": {
#     "leveling_platform": true,
#     "railways": true,
# },
# "warehouse_class": "A",
# "warehouse_variant": "No value",
