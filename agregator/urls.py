...
from agregator.views import WarehouseImagesRetrieveAPIView, WarehouseListAPIView, WarehouseAPIView, WarehouseDetailAPIView, privets
...
urlpatterns = [
	...
	path('test', privet(), name="warehouse-test"),
]
